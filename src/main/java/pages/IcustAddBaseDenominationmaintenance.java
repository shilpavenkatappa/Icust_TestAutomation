...
public class IcustAddBaseDenominationmaintenance extends IcustSpecificMethods{
	...
	public IcustAddBaseDenominationmaintenance selectBaseDenominationMaintenance() 
	{
		...
		wait(5000);
		clickElement(locateElement("xpath", props.getProperty("IcustMaintenance.BaseDenominationMaintenance.AddNew.Xpath")));
		return this;
	}
	
	public IcustAddBaseDenominationmaintenance enterDenomination() {
		enterValue(locateElement("xpath", props.getProperty("IcustMaintenance.Maintenance.Bank.AddNew.Denomination.Xpath")), props.getProperty("BankName"));
		return this;
	}
